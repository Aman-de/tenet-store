...
interface BottomSceneProps {
    bottom: ProductItem;
    accentColor?: string;
}

export const BottomScene: React.FC<BottomSceneProps> = ({
    bottom,
    accentColor = "#E0A96D",
}) => {
    ...
    return (
        ...
        >
            {/* Minimal Ambient Denim Glow */}
            <div
                style={{
                    position: "absolute",
                    inset: 0,
                    background: "radial-gradient(circle at 50% 45%, #131B2A 0%, #05070B 80%)",
                }}
            />
