...
export default async function InnerCirclePage() {
    ...
    if (!userId || !user) {
        return (
            <div className="min-h-screen pt-32 lg:pt-28 pb-32 lg:pb-20 px-4">
    ...
    return (
        <div className="min-h-screen pt-32 lg:pt-28 pb-32 lg:pb-20 px-4 animate-in fade-in duration-500">
