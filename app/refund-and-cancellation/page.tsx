        ...
        <main className="pt-32 pb-32 lg:pb-24 min-h-screen">
            <div className="max-w-3xl mx-auto px-6">
                ...
                <div className="space-y-12 text-[#1A1A1A] dark:text-[#F4F1ED]/80 font-sans leading-relaxed">
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Returns Policy</h2>
                    ...
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Refund Process</h2>
                    ...
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Order Cancellations</h2>
                    ...
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Exchanges</h2>
