        ...
        <main className="pt-32 pb-32 lg:pb-24 min-h-screen">
            <div className="max-w-3xl mx-auto px-6">
                <header className="mb-16 text-center">
                    <h1 className="font-serif text-4xl md:text-5xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-6">Privacy Policy</h1>
                ...
                <div className="space-y-12 text-[#1A1A1A] dark:text-[#F4F1ED]/80 font-sans leading-relaxed">
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Information We Collect</h2>
                    ...
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">How We Use Your Information</h2>
                    ...
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Information Sharing</h2>
                    ...
                    <section>
                        <h2 className="font-serif text-2xl text-[#1A1A1A] dark:text-[#F4F1ED] mb-4">Your Rights</h2>
