...
export default function ProductSection({ products }: ProductSectionProps) {
    ...
    return (
        <section ref={sectionRef} id="new-arrivals" className="relative max-w-[2000px] w-full mx-auto px-4 lg:px-12 pt-2 pb-4 lg:py-12">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-1.5 lg:mb-4 gap-2 lg:gap-4">
                <div className="flex items-baseline gap-3 md:gap-6 flex-1">
                    <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-[#1A1A1A] dark:text-[#F4F1ED]">
                        New Arrivals
                    </h2>
