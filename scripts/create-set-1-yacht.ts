...
const HERO_IMAGE = "hero_yacht_club_1770239426661.png"
const FLAT_IMAGE = "flat_yacht_club_1770239400350.png"

const product = {
    name: "The Yacht Club Edit",
    price: 45000,
    category: "knitwear", // Using 'knitwear' broadly as per previous logic, or maybe 'outerwear' since it has a blazer? Let's stick to existing schema enums.
    color: "Navy & White",
    colorHex: "#000080",
    ...
    image_prompt: "Navy blue double-breasted blazer, white chinos, light blue oxford shirt, brown leather boat shoes."
}

async function createYachtClubEdit() {
    ...
    try {
        ...
        const doc = {
            _type: 'product',
            title: product.name,
            slug: { _type: 'slug', current: 'the-yacht-club-edit' },
            price: product.price,
            originalPrice: 52000,
