...
const HERO_IMAGE = "hero_manhattan_evening_1770240522517.png"
const FLAT_IMAGE = "flat_manhattan_evening_1770240506927.png"

const product = {
    name: "The Manhattan Evening Edit",
    price: 62000,
    category: "outerwear",
...
async function createManhattanEveningEdit() {
    ...
    try {
        ...
        const doc = {
            _type: 'product',
            title: product.name,
            slug: { _type: 'slug', current: 'the-manhattan-evening-edit' },
            price: product.price,
            originalPrice: 75000,
