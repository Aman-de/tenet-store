...
const HERO_IMAGE = "hero_aegean_m_1_1770667903822.png"
const FLAT_IMAGE = "flat_aegean_m_1_1770667919410.png"

const product = {
    name: "The Aegean Odyssey",
    price: 44000,
    category: "sets",
    ...
    image_prompt: "Man walking through white streets of Mykonos, white grandad collar shirt, striped seersucker trousers."
}

async function createAegeanProduct() {
    ...
    try {
        ...
        const doc = {
            _type: 'product',
            title: product.name,
            slug: { _type: 'slug', current: 'the-aegean-odyssey' },
            price: product.price,
            originalPrice: 48000,
