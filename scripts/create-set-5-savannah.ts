...
const HERO_IMAGE = "hero_savannah_explorer_1770240457660.png"
const FLAT_IMAGE = "flat_savannah_explorer_1770240440949.png"

const product = {
    name: "The Savannah Explorer Edit",
    price: 48000,
    category: "outerwear",
    color: "Beige & White",
    colorHex: "#F5F5DC",
...
async function createSavannahExplorerEdit() {
    ...
    try {
        ...
        const doc = {
            _type: 'product',
            title: product.name,
            slug: { _type: 'slug', current: 'the-savannah-explorer-edit' },
            price: product.price,
            originalPrice: 58000,
