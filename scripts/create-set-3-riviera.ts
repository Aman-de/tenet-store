...
const HERO_IMAGE = "hero_riviera_m_1_1770663283747.png"
const FLAT_IMAGE = "flat_riviera_m_1_1770663297989.png"

const product = {
    name: "The Riviera Retreat",
    price: 42000,
    category: "sets",
    color: "White & Navy",
    colorHex: "#FFFFFF",
    ...
    image_prompt: "Man relaxing on a vintage wooden boat in the Mediterranean, white linen shirt, navy swim shorts."
}

async function createRivieraProduct() {
    ...
    try {
        ...
        const doc = {
            _type: 'product',
            title: product.name,
            slug: { _type: 'slug', current: 'the-riviera-retreat' },
            price: product.price,
            originalPrice: 48000,
